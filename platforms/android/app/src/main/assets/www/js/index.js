...
document.addEventListener('push-notification', 
	function(event) { 
		...
		'Michigan Elections Alert', //notification title. you can put a constant name here or retrieve a notification header from event.notification.userdata
		'Done' // name of your button 
		);
		} 
	}
